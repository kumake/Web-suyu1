						...
						<table id="__01" width="751" height="630" border="0" cellpadding="0" cellspacing="0">
							...
							<tr>
								...
								<%
												...
												'''''模型表名称
												Dim ModelTable:ModelTable ="user_sycs"
											...
											%>
											  <%
														...
														set rs = UICon.Query("select * from user_sycs where ID="&ItemID&"")
														UIcon.execute("update user_sycs set Hots=Hots +1 where id="&ItemID&"")
											  ...
											  <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
													  ...
													  <table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
														  <td height="35" align="left" valign="middle" class="news_fabutime" style="font-weight: bold">发布时间：<%=rs("posttime")%></td>
															...
															上一篇文章：
																<%
													set rsu = Uicon.query("select top 1 id,categoryid,title from user_sycs where categoryid="&categoryid&" and id<"&itemid&" order by id desc")
												...
												<tr>
												  <td height="26">下一篇文章：
													<%
													set rsn = Uicon.query("select top 1 id,categoryid,title from user_sycs where categoryid="&categoryid&" and id>"&itemid&" order by id asc")
