...
<body>
<div id="container">
<table id="__01" width="981" height="872" border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td>
	...
	<tr>
		<td>
		<table id="__01" width="981" height="650" border="0" cellpadding="0" cellspacing="0">
					<tr>
						<td>
						<table id="__01" width="230" height="630" border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td>
									<img src="images/neiye_jj_01.jpg" width="230" height="51" alt=""></td>
							</tr>
							<tr>
								<td background="images/neiye_jj_02.jpg" width="230" height="554">
								<!--#include file="left.asp" -->
								</td>
							</tr>
							<tr>
								<td>
									<img src="images/neiye_jj_03.jpg" width="230" height="25" alt=""></td>
							</tr>
						</table>
					</td>
					<td>
						<table id="__01" width="751" height="630" border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td>
									<img src="images/neiye_ll_01.jpg" width="751" height="182" alt=""></td>
							</tr>
							<tr>
								<td background="images/neiye_ll_02.jpg" width="751" height="35">
								<div style="padding-top:9px; font-size:13px; color:#000; font-weight:bold; margin-left:25px;">家电常识</div>
								</td>
							</tr>
							<tr>
								<td width="751" height="413">
									<div id="neiye_main">
								<!--内容开始 -->
								<div style="line-height:30px; margin-top:20px ">
												...
												if total = 0 then 
												Dim Tarray:Tarray = UICon.QueryData("select count(*) as total from user_sycs where "&strwhere&"")
												...
												'Dim sql:sql = UICon.QueryPageByNum("categoryID,id,title,posttime","user_sycss", ""&strwhere&"", "ID", true,current_page,pagesize)
												'这种方式为根据IndexID排序，IndexID值越大越靠前
												Dim sql:sql = UICon.QueryPageByNotIn("*","user_sycs", ""&strwhere&"", "ID", "indexID desc,ID",false,current_page,pagesize)
												'response.Write sql
												'response.End()
												...
												<span style="font-family:'宋体';">·</span><a href="sycs_in.asp?categoryid=<%=rsn("categoryID")%>&amp;itemid=<%=rsn("id")%>" class="y_0"><%=rsn("title")%></a> </td>
												</tr>
												</table>
												<%
												rsn.movenext
