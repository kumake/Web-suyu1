					...
					<td>
						<table id="__01" width="751" height="630" border="0" cellpadding="0" cellspacing="0">
							...
							<tr>
								...
								<div style="padding-top:9px; font-size:13px; color:#000; font-weight:bold; margin-left:25px;">人才招聘</div>
								</td>
							</tr>
							<tr>
											...
											%>
											  ...
											  <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
													  ...
													  <table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
														  <td height="35" align="left" valign="middle" class="news_fabutime" style="font-weight: bold">发布时间：<%=rs("posttime")%></td>
															...
															上一篇文章：
																<%
													set rsu = Uicon.query("select top 1 id,categoryid,title from user_rec where categoryid="&categoryid&" and id<"&itemid&" order by id desc")
												...
												<tr>
												  <td height="26">下一篇文章：
													<%
													set rsn = Uicon.query("select top 1 id,categoryid,title from user_rec where categoryid="&categoryid&" and id>"&itemid&" order by id asc")
